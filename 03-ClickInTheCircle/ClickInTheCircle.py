...
def main():
    ...
    pygame.mixer.music.load("bar.wav")
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                print(mousepos)
                distance1 = distance(mousepos, circle_center)
                print(distance1)
                if distance1 < circle_radius:
                    print(distance1)
                    message_text = "ok"
        ...
        onscreen_message = font.render(message_text, True, (255, 255, 255))
        screen.blit(onscreen_message, (20, 300))
